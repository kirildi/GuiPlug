...
GUIPLUG::ManagerWindow::ManagerWindow()
{
}
...
void GUIPLUG::ManagerWindow::placeContent(ImGuiViewport *viewPort, ImFont &mainFont24px, ImFont &mainFont42px)
{
                                 ...
                                 ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoMove))
      {
            ...
            auto wizardResult = wizardWindow.showWizard("wzProject");
            if (wizardResult)
            {
                  openNewProj = true;
                  isNewProject = true;
